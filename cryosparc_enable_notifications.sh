...
username="" # Necessary. Your chosen username from the README section "Enabling Slack Notifications for CryoSPARC." This will tell the functions which person to send the Slack notifications to.
